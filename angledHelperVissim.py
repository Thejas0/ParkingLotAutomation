...
def addLinkAngled(row, col, angle, ct, roadWidth, pWidth, pLength, parkWidth):
    """
...
def connectUTurn(grid, check, angle1, reqAngle, item1, x, y, z, width, isDecimal, roadWidth, count):
    """
...
def connectUTurnInit(grid, width, isDecimal, roadWidth, count,start):
    """
                ...
                if (m == 'SD'):
                    ...
                    if (angle1 == 270):
                        ...
                        count += connectUTurn(grid, check, angle1,
                                              reqAngle, item, i, j, k, width, isDecimal, roadWidth, count)
                    elif (angle1 == 90):
                        reqAngle = 270
                        # check = [0, -1]
                        check = [0, -width]
...
def parkingLotinit(grid, baseLink, roadWidth, pWidth, pLength, parkWidth, parkingLength):
    """
        ...
        for i in range(len(lines)):
            ...
            if (s[0][0] == 'x'):
                ...
                linkPark = addLinkAngled(
                    rowPark, colPark, anglePark, ct, roadWidth, pWidth, pLength, parkWidth)
                # Step2  - Connector
